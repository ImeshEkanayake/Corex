"""
Customizing Spectral Normalization from https://arxiv.org/abs/1802.05957
"""
import torch
...
class SpectralNorm:
    ...
    def __init__(self, name: str = 'weight', n_power_iterations: int = 1, dim: int = 0, eps: float = 1e-12, thres:float = 1.0) -> None:
        self.name = name
        self.dim = dim
...
def spectral_norm(module: T_module,
    ...
    if dim is None:
        if isinstance(module, (torch.nn.ConvTranspose1d,
            ...
            dim = 0
    SpectralNorm.apply(module, name, n_power_iterations, dim, eps, thres)
    return module
