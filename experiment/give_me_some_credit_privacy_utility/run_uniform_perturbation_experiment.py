#!/usr/bin/env python3
"""Standalone Give Me Some Credit uniform_perturbation privacy--utility experiment.

This source contains the full Table 2 implementation and writes outputs under uniform_perturbation/outputs by default.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=SCRIPT_DIR / "uniform_perturbation" / "outputs")
