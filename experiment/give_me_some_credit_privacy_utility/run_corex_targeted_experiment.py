#!/usr/bin/env python3
"""Standalone Give Me Some Credit corex_targeted privacy--utility experiment.

This source contains the full Table 2 implementation and writes outputs under corex_targeted/outputs by default.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=SCRIPT_DIR / "corex_targeted" / "outputs")
